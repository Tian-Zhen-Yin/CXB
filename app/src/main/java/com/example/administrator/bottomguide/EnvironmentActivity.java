...
public class EnvironmentActivity extends AppCompatActivity implements OnBannerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.env_list);
    ...
    private void initHealth() {
        if(healthList.size()==0) {
            Health heart = new Health(R.drawable.environment, "102", "轻度污染");
